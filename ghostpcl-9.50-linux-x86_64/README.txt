...
Linux x86_64/amd64. The executable handles files in the PCL/XL language family.

These GhostPDL builds are command-line tools. As far as is practical,
this binary is statically linked, for the widest compatibility.
